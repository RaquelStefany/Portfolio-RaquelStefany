...
import "./About.css";
import AboutImg from "../../assets/img/Raquel.png";
import CV from "../../assets/pdf/Curriculo_Raquel_Stefany.pdf";
  ...
  return (
    <section className="about section" id="sobre">
      ...
      <div className="about__container container grid">
        <img src={AboutImg} alt="Foto Raquel Stefany" className="about__img" />
